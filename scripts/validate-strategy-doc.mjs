...
const ddlBlock = sqlBlocks.find((block) =>
  block.includes("CREATE TYPE cer_session_status"),
);
const vectorBlock = sqlBlocks.find((block) =>
  block.includes("CREATE TABLE agent_cer_profile_embedding"),
);
...
try {
  ...
  await database.exec(`
    ...
    INSERT INTO agent_cer_authorization_evidence (
    ...
    INSERT INTO agent_cer_profile (
      ...
      'Incident containment-expiry-review', 'DRAFT',
      repeat('a', 64), 'jcs-v1', 'cer-compiler-1',
      NULL, '30000000-0000-0000-0000-000000000001',
      repeat('d', 64), 3600000, 4, 2, 32, 32,
      ARRAY['incident', 'containment-expiry-review'],
      'proc:containment-expiry-review-incident',
      'STOP_BEFORE_EVALUATE', 'principal:test', now()
    );

    INSERT INTO agent_cer_profile_review_rule (
    ...
    SELECT approve_agent_cer_profile(
      101,
    ...
    INSERT INTO agent_cer_containment_catalog (
    ...
    INSERT INTO agent_cer_session (
      ...
      'Review expired containments without inventing trust',
      'request-1',
    ...
    INSERT INTO agent_cer_nomination_window (
    ...
    INSERT INTO agent_cer_evaluation_receipt (
    ...
    INSERT INTO agent_cer_review_certificate (
    ...
    INSERT INTO agent_cer_review_binding (
    ...
    INSERT INTO agent_cer_profile_embedding (
  ...
  await expectDatabaseRejection(
    () =>
      database.exec(`
        ...
        UPDATE agent_cer_profile_review_rule
  ...
  await expectDatabaseRejection(
    () =>
      database.exec(`
        ...
        UPDATE agent_cer_review_binding
  ...
  await expectDatabaseRejection(
    () =>
      database.exec(`
        ...
        INSERT INTO agent_cer_effect_intent (
  ...
  await expectDatabaseRejection(
    () =>
      database.exec(`
        ...
        UPDATE agent_cer_effect_intent
  ...
  const tenantCount = await database.query(
    "SELECT count(*)::int AS count FROM agent_cer_session WHERE account_id = 101",
  );
